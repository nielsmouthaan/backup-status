...
struct Provider: AppIntentTimelineProvider {
    ...
    func timeline(for configuration: ConfigurationAppIntent, in context: Context) async -> Timeline<SimpleEntry> {
        ...
        let startOfDayAfterTomorrowEntry = SimpleEntry(date: startOfDayAfterTomorrow, configuration: configuration, preferences: preferences) // Needed to update from Tomorrow to later.
